  ...
  <div class="common-layout">
    ...
    <el-container style="height: 100vh">
      ...
      <el-aside class="aside" :width="asideWidth">
        ...
        <!-- 设置router属性后 可以在el-menu-item标签中通过index属性来指定路由的路径 -->
        <!-- default-active 默认激活的菜单栏, 将菜单栏与路径做了对应关系 -->
        <!-- collapse 是否折叠 -->
        <el-menu
          class="aside-menu"
          router
        ...
        >
          <!-- for循环路由规则 -->
          <!-- routers就是router/index.js中的routers-->
      ...
      <el-container>
        ...
        <el-footer class="footer">
          <el-icon style="width: 2em; top: 3px; font-size: 18px"
            ><place
          /></el-icon>
          <a class="footer el-icon-place">2023 k8s devops</a>
        </el-footer>
